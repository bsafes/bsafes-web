	...
	function saveOtherTypesContent() {
        ...
        function startUploadingOtherTypesContent() {
			...
			var encodedContent = forge.util.encodeUtf8(content);
			var arraybufferContent = str2ab(encodedContent);
	...
	function loadLibrayJsCss(content_type, done)
	{
		...
		if (content_type == constContentTypeDraw) {
			...
			var template = `
				<link rel="stylesheet" href="/javascripts/syncfusion/css/material.css">				
				<link rel="stylesheet" href="https://s3.amazonaws.com/com.openbsafes.code/javascripts/libraryInit/syncfusion.docEditor.css">				
				...
				<script src="http://localhost:8000/javascripts/libraryInit/syncfusion.docEditor.js"></script>
			`;
                        ...
                        xhr.onload = function(e) {
                            ...
                            $.post('/memberAPI/postS3Download', {
                                ...
                                if (data.status === 'ok') {
                                    ...
                                    //var decodedContent = forge.util.decodeUtf8(arraybufferContent);
